...
interface FamilyDashboardProps {
  appMode?: boolean; // When true, hides hero/marketing sections
}
...
const FamilyDashboard: React.FC<FamilyDashboardProps> = ({ appMode = false }) => {
  ...
  return (
    <div
      className={
        appMode
          ? 'min-h-0 text-gray-800 dark:text-gray-100'
          : 'min-h-screen bg-teal-50 text-gray-800 dark:bg-gray-900 dark:text-gray-100'
      }
    >
      ...
      {/* Quick Actions Bar */}
      <div className="border-b border-teal-100/80 bg-white/90 backdrop-blur-sm dark:border-teal-900/40 dark:bg-gray-800/80">
      ...
      <main className="container mx-auto px-4 sm:px-6 py-4 sm:py-6">
          ...
          <div className="mb-6 overflow-hidden rounded-2xl border border-teal-200 bg-white shadow-md shadow-teal-900/5 dark:border-teal-800 dark:bg-gray-800 dark:shadow-black/20">
            <div className="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between sm:p-5">
              <div className="flex items-start gap-3 sm:items-center">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-teal-600 text-white shadow-sm dark:bg-teal-700">
              ...
              <label className="w-full sm:w-auto sm:min-w-[220px]">
                ...
                <select
                  ...
                  className="w-full cursor-pointer appearance-none rounded-xl border-2 border-slate-200 bg-slate-50 py-3 pl-4 pr-10 text-sm font-semibold text-slate-900 shadow-sm transition-colors focus:border-teal-500 focus:outline-none focus:ring-2 focus:ring-teal-500/30 dark:border-gray-500 dark:bg-gray-800 dark:text-white dark:focus:border-teal-400"
                  style={{
        ...
        {/* Learning Hub Quick Access - Teal Theme - Hidden in app mode */}
        {!appMode && (
        <div 
            ...
            {familyMembers.length === 0 ? (
              ...
              <div className="space-y-4">
                {familyMembers.map(member => (
                  <div 
                    key={member.id} 
                    className="border-2 border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4 hover:border-green-300 dark:hover:border-green-600 transition-all"
                  >
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      <div className="flex items-center gap-4 flex-1">
                        <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-teal-600 flex items-center justify-center text-white text-lg sm:text-xl font-bold shadow-sm flex-shrink-0 dark:bg-teal-700">
            ...
            {familyGoals.length === 0 ? (
              ...
              <div className="space-y-4">
                {familyGoals.map(goal => (
                  <div 
                    key={goal.id} 
                    className={`border-2 rounded-lg p-4 hover:border-green-300 dark:hover:border-green-600 transition-all bg-gray-50 dark:bg-gray-800/50 ${
