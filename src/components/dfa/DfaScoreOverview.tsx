...
const DfaScoreOverview: React.FC<Props> = ({ analysis }) => {
  ...
  return (
    <section className="mb-8 rounded-3xl border border-gray-200 bg-gradient-to-br from-white via-gray-50 to-green-50/60 p-6 shadow-sm dark:border-gray-700 dark:from-gray-800 dark:via-gray-800 dark:to-green-950/30">
      <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
        <div>
          ...
          <h2 className="mt-3 text-2xl font-bold text-gray-900 dark:text-gray-100">Launch-grade scoring, not just a footprint list</h2>
      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[320px,1fr]">
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="mt-4 rounded-xl bg-gray-50 p-4 text-sm text-gray-700 dark:bg-gray-900/50 dark:text-gray-300">
