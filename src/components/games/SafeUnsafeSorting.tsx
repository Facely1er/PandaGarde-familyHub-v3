          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
              ...
              <div className="space-y-3">
                {currentItems.map(item => (
                  <div
                    key={item.id}
                    className="bg-white dark:bg-gray-200 border border-gray-200 dark:border-gray-600 rounded-lg p-4 text-center"
                  >
            ...
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
              ...
              <div className="space-y-2">
                <div className="bg-white dark:bg-gray-200 border border-green-200 dark:border-green-700 rounded p-3 text-sm text-green-700 dark:text-green-300">
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
              ...
              <div className="space-y-2">
                <div className="bg-white dark:bg-gray-200 border border-red-200 dark:border-red-700 rounded p-3 text-sm text-red-700 dark:text-red-300">
                  ✗ Sharing passwords
                </div>
                <div className="bg-white dark:bg-gray-200 border border-red-200 dark:border-red-700 rounded p-3 text-sm text-red-700 dark:text-red-300">
