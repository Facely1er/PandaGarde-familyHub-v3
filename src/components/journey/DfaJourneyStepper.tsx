...
const DfaJourneyStepper: React.FC<Props> = ({
  ...
  return (
    <section className="rounded-2xl border border-green-200 bg-gradient-to-br from-green-50 via-white to-sky-50 p-5 shadow-sm dark:border-green-800/50 dark:from-green-950/40 dark:via-gray-900 dark:to-gray-900">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div className="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 text-sm font-semibold text-green-800 ring-1 ring-green-200 dark:bg-gray-800/90 dark:text-green-300 dark:ring-green-800/50">
        ...
        <div className="min-w-[220px] rounded-xl border border-green-200 bg-white/90 px-4 py-3 dark:border-green-800/50 dark:bg-gray-800/90">
          <div className="text-sm font-semibold text-gray-800 dark:text-gray-100">{journey.progressPercent}% complete</div>
            ...
            <Link
              ...
              className={`rounded-2xl border p-4 transition-all hover:-translate-y-0.5 hover:shadow-md ${
                isCurrent
                  ...
                  : isComplete
                    ? 'border-green-300 bg-green-50 text-gray-900 dark:border-green-800 dark:bg-green-950/50 dark:text-gray-100'
                    : isVisited
                      ? 'border-sky-300 bg-sky-50 text-gray-900 dark:border-sky-800 dark:bg-sky-950/40 dark:text-gray-100'
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                {isComplete ? (
                  ...
                  <Circle size={20} className={isCurrent ? 'text-white/80' : 'text-gray-300 dark:text-gray-600'} />
                )}
              </div>
