...
const btnBlueClass =
  'inline-flex items-center justify-center gap-2 px-4 py-2 text-sm font-semibold text-white bg-green-700 hover:bg-green-800 dark:bg-green-600 dark:hover:bg-green-500 rounded-md transition-colors';
        ...
        {pointsOfContact.length === 0 ? (
          ...
          <div className="flex flex-col gap-3">
            {pointsOfContact.map((contact) => (
              <div
                key={contact.id}
                className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 rounded-lg bg-gray-50 dark:bg-gray-800 p-4"
              >
