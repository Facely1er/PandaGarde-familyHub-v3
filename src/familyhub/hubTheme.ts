...
export const hubTheme = {
  ...
  /** Tighter padding for dense settings-style surfaces */
  cardCompact: 'rounded-xl border border-gray-200 bg-white p-3 shadow-sm dark:border-gray-700 dark:bg-gray-800',
