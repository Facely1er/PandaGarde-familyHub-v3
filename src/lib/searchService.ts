  ...
  private async loadSearchContent(): Promise<void> {
    ...
    this.searchIndex = [
      ...
      },
      {
        ...
        description: 'Age-matched missions and saved progress in Family Hub on this device',
      ...
      },
      {
        ...
        description: 'Review on the website, learn with resources, continue in Family Hub',
        content_type: 'page',
        url: '/how-it-works',
        category_id: 'privacy',
        tags: ['how-it-works', 'overview', 'journey'],
        metadata: {},
        is_active: true,
        sort_order: 5,
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        description: 'Privacy laws, MODPA, and how to exercise your data rights',
        content_type: 'page',
        url: '/digital-rights',
        category_id: 'privacy',
        tags: ['rights', 'law', 'modpa'],
        metadata: {},
        is_active: true,
        sort_order: 11,
        created_at: new Date().toISOString(),
      ...
      },
      {
        ...
        description: 'Stories, parent guides, and printables',
        content_type: 'page',
        url: '/for-families',
        category_id: 'privacy',
        tags: ['resources', 'guides'],
        metadata: {},
        is_active: true,
        sort_order: 10,
        created_at: new Date().toISOString(),
      ...
      },
      {
        id: 'family-hub',
        title: 'Family Hub',
        description: 'Missions and progress on your device',
        content_type: 'page',
        url: '/family-hub',
        category_id: 'privacy',
        tags: ['family-hub', 'missions'],
        metadata: {},
        is_active: true,
        sort_order: 11,
        created_at: new Date().toISOString(),
