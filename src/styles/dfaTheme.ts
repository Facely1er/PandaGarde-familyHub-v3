/**
 * Semantic tokens for DFA journey pages. Gray scale is Tailwind-semantic
 * (100=light, 900=dark); dark:* aliases live in tailwind.config.js.
 */
export const dfaTheme = {
  ...
  btnOutline:
    'inline-flex items-center gap-2 rounded-lg border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50 dark:border-dark-border dark:bg-dark-surface-elevated dark:text-dark-text-primary dark:hover:bg-gray-700',
